...
* ADDED VARIABLE
        CCO2TOT(t)      Total CO2 emissions (GtCO2)
*
...
* ADDED EQUATION
        CCO2TOTEQ(t)     Cumulative total CO2 emissions
*
...
* ADDED EQUATION
 cco2toteq(t+1)..     CCO2TOT(t+1)   =E= CCO2TOT(t) + tstep*ECO2(t) ;
*
